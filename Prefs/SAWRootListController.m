...
- (void)viewDidLoad {
    ...
    [[self enableSwitch] setOnTintColor:[UIColor colorWithRed: 0.95 green: 0.63 blue: 0.45 alpha: 1.00]];
    ...
    [[self iconView] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/SafariWallpaperPrefs.bundle/icon.png"]];
    ...
    [[self headerImageView] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/SafariWallpaperPrefs.bundle/Banner.png"]];
